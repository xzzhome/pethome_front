<template>
	<section>
		...
		<el-col :span="24" class="toolbar">
			...
			<el-pagination layout="prev, pager, next" @current-change="handleCurrentChange" :current-page="query.currentPage" :page-size="query.pageSize" :totals="pageData.totals" style="float:right;">
			</el-pagination>
		</el-col>
	...
	export default {
		...
		methods: {
			...
			getSearchMasterMsgs() {
				...
				this.$http.post("/searchMasterMsg/toAudit",this.query)
                    .then(result => {
                        this.pageData.data = result.data.data;
                        this.pageData.totals = result.data.totals
